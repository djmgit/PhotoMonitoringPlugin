...
These are the bundled software packages and the platfors that are supported:
...
NOTE: Support for OS X is coming but for now it is best to download the “Fiji Life-Line version, 2014 November 25” file from the website linked above and then follow the directions in the plugin installation guide.
